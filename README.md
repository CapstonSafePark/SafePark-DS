...
pip install flask torch torchvision opencv-python numpy easyocr pilloww

2. 모델 파일 준비
weight 폴더를 생성 후 아래 파일 삽입

weights/End-to-end.pth
weights/lane_crop_type_classifier.pth

폴더 구조
SafePark-DS/app.py, lane_detector.py, train_lane_crop_classifier.py, prepare_bdd100k_lane_crop_dataset.py, weigths, uploads/
